...
function Card(props){
    ...
    return (
        <div className="card">
            <div className="top">
                <div className="star"><img src={(props.profile.featured)?`${process.env.PUBLIC_URL}/star.png`:`${process.env.PUBLIC_URL}/unstar.png`} alt="star" /></div>
                <Avatar link={(props.profile.profileImage === null)?'image.png':props.profile.profileImage} alt={props.profile.name}/>
            ...
            <div className="bottom">
                ...
                {(props.profile.status==="online")?<div className="status lightGray tiny bold space10"><div className="dot online" />Online</div>:<div className="status lightGray tiny bold space10"><div className="dot offline" />Last seen: {(()=>{
                    const lastseen = new Date("2024-09-24T14:30:00Z");
                    const current = new Date();
                    const timeSince = lastseen - current;
